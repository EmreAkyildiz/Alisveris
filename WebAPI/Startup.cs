...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ISepetUrunService, SepetUrunManager>();
            services.AddSingleton<ISepetUrunDal, EfSepetUrunDal>();
            services.AddSingleton<IMusteriSepetService, MusteriSepetManager>();
